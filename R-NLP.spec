...
Version  : 0.1.11
Release  : 2
URL      : https://cran.r-project.org/src/contrib/NLP_0.1-11.tar.gz
Source0  : https://cran.r-project.org/src/contrib/NLP_0.1-11.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521246649
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library NLP|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
